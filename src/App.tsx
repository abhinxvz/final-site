                  ...
                  >
                      ...
                      <div className="w-full h-full relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-white px-4">
                            <h2 className="font-quantum text-8xl font-bold mb-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">DARE TO BE</h2>
                    ...
                    <SwiperSlide>
                      <div className="w-full h-full relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-white px-4">
                            <h2 className="font-quantum text-8xl font-bold mb-6 drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">DARE TO RISE</h2>
                            <p className="font-quantum text-6xl drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]">  </p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
